...
class MultMatrizTest2 extends AnyFunSuite{
  test("test req 1 1x1 ") {
    val matrices = new Matrices()
    val e4 = matrices.multMatrozRec(Vector(Vector(1)), Vector(Vector(2)))
    assert(e4 == Vector(Vector(2)))
  }
  test("test req 2 2x2 ") {
    val matrices = new Matrices()
    val e2 = matrices.multMatrozRec(Vector(Vector(2, 0), Vector(1, 2)), Vector(Vector(1, 2), Vector(3, 4)))
  ...
  test("test req 3 4x4 "){
    ...
    val result = matrices.multMatrozRec(matrix1, matrix2)
  ...
  test("test reqsec 1 1x1 ") {
    val matrices = new Matrices()
    val e4 = matrices.multMatrizRecSec(Vector(Vector(1)), Vector(Vector(2)))
    assert(e4 == Vector(Vector(2)))
  }
  test("test reqsec 2 2x2 ") {
    val matrices = new Matrices()
    val e2 = matrices.multMatrizRecSec(Vector(Vector(2, 0), Vector(1, 2)), Vector(Vector(1, 2), Vector(3, 4)))
    assert(e2 == Vector(Vector(2, 4), Vector(7, 10)))
  }

  test("test reqsec 3 4x4 "){
    val matrices = new Matrices()
    val matrix1 = Vector(Vector(1, 2, 3, 4), Vector(5, 6, 7, 8), Vector(9, 10, 11, 12), Vector(13, 14, 15, 16))
    val matrix2 = Vector(Vector(16, 15, 14, 13), Vector(12, 11, 10, 9), Vector(8, 7, 6, 5), Vector(4, 3, 2, 1))
    ...
    val result = matrices.multMatrizRecSec(matrix1, matrix2)
    val expected = Vector(Vector(80, 70, 60, 50),
      Vector(240, 214, 188, 162),
      Vector(400, 358, 316, 274),
      Vector(560, 502, 444, 386))
